  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">🎰 Machine a Sous</h1>
      ...
      <Card className="bg-primary/5 border-primary/20">
        ...
        <CardContent>
          <ul className="text-sm text-muted-foreground space-y-2 list-disc list-inside">
            ...
            <li>Alignez 3, 4 ou 5 numeros identiques pour gagner</li>
            <li>Le numero 7 est le jackpot (x10 a x500)</li>
            <li>Une sequence croissante (0-1-2-3-4, etc.) remporte tous les points de la machine !</li>
          </ul>
        </CardContent>
      </Card>
    </div>
